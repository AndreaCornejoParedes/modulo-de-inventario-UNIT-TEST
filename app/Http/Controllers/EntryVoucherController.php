    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            foreach ($request->Entradas as $entrada) {
                DB::select("call sp_guardar_cuerpo_vale_entrada(?,?,?,?,?)", array($calculated,$entrada['ID'],$entrada['Cantidad'],$entrada['Observacion'],$entrada['Status'] == true ? 1 : 0,));
            }
