...
<div id="page_pdf">
        ...
        <tr>
            ...
            <td class="info_factura">
                <div class="round">
                    ...
                    <p>Codigo: <strong>{{$voucher->ID_vale_entrada}}</strong></p>
                    <p>Guia de remisión: {{$voucher->Codigo_guia_remision}}</p>
                    <p>Fecha: {{$voucher->Fecha_recepcion}}</p>
                    <p>Hora: {{ $voucher->Hora }}</p>
                    @if($voucher->Activo == 1)
                        <p>Estado: Activo</p>
                    @else
                        <p>Estado: Inactivo</p>
    ...
    <table id="factura_detalle">
        <thead>
        <tr>
            <th width="10%">Numero de parte</th>
            <th width="20%">Descripción</th>
            <th width="5%">Cantidad Recibida</th>
            <th width="30%">Observacion</th>
            <th width="10%">Status</th>
            <th class="textright" width="15%">Ubicacion</th>
        </tr>
        </thead>
        <tbody id="detalle_productos">
        @foreach($entries as $entry)
            <tr>
                <td class="textcenter">{{$entry->ID}}</td>
                ...
                @endif
                <td class="textcenter">{{$entry->Ubicacion}}</td>
            </tr>
        @endforeach
