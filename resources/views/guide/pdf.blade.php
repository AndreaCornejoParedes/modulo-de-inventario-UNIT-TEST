...
<div id="page_pdf">
        ...
        <tr>
            <td class="info_empresa">
                <div>
                    ...
                    <a class="h4">Reporte de las guías de remisión con todos los Medicamentos que contienen</a>
                </div>
            </td>
    ...
    <table id="factura_detalle">
        ...
        <tr>
            ...
            <th width="10%">Número de parte</th>
        ...
        @foreach($datos as $dato)
            <tr>
                ...
                <td class="textcenter">{{$dato->ID_vale_entrada}}</td>
                <td class="textcenter">{{$dato->ID}}</td>
                <td class="textcenter">{{$dato->Descripcion}}</td>
                <td class="textcenter">{{$dato->Fecha_recepcion}}</td>
                <td class="textcenter">{{$dato->Unidad_de_medida}}</td>
            </tr>
        @endforeach
