...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{url('/material/create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                class="fas fa-plus-circle text-white-50"></i> Crear Medicamento </a>
    </div>
...
<script>
    function deleteConfirmation(numparte){
        Swal.fire({
            title: "¿Estás Seguro?",
            html: 'El medicamento: <strong>'+numparte+'</strong> será eliminado permanentemente',
            icon: 'warning',
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        if (results.status == 1) {
                            ...
                            Toast.fire({
                                icon: 'error',
                                html: '<strong>El medicamento '+numparte+' '+test+'</strong>',
                            });
                        }
                    }
                });
